document.querySelector('.add-option')
    .addEventListener(
        "click",
        () => {
            ...
            optionGroup.innerHTML = `
                <label for="option_${length}">Other</label>
                <input class="vote-option col-9 form-control" id="option_${length}" name="options[]" placeholder="Other">
            ...
            document.querySelector(".vote-option-group")
                ...
                .querySelector('.remove-option').addEventListener(
                "click",
